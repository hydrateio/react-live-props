              ...
              <React.Fragment>
                {componentProps && Object.keys(componentProps).length > 0 && (
                  <table>
                    <thead>
                      <tr>
                        <th className={cs('rlpPropName', styles.rlpPropName)}>Property</th>
                        <th className={cs('rlpTypeName', styles.rlpTypeName)}>Type</th>
                        <th className={cs('rlpDescription', styles.rlpDescription)}>Description</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        return (
                          <tr key={propName}>
                            <td className={cs('rlpPropName', styles.rlpPropName)}>
                              {propName}
                              {property.required && (
                                <span className={cs('rlpRequired', styles.rlpRequired)}>(required)</span>
                              )}
                            </td>
                ...
                {(!componentProps || Object.keys(componentProps).length === 0) && (
                  <div className={cs('rlpNoAvailableProperties', styles.rlpNoAvailableProperties)}>
                    <em>There are no properties for the selected component type</em>
                  </div>
                )}
              </React.Fragment>
            )
