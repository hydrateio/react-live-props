...
export default class PropsTableEditor extends Component {
  static propTypes = {
          ...
          return (
            <RendererContext.Provider value={{ ...Renderers }}>
              ...
              >
                <PropsTable
                  enableEditor
                  selectedComponentDisplayName={editingComponent}
                >
                  {({ prop }) => {
                    if (!filteredSchema[prop]) return null

                    return (
                      <RendererResolver
                        type={filteredSchema[prop].type}
                        name={prop}
                        displayName={prop}
                        value={currentComponent.props[prop]}
                        onChange={onChange}
                        property={filteredSchema[prop]}
                        hidePropInfo
                      />
                    )
                  }}
